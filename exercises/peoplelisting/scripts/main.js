...
// get elements
const peopleListingTableBody = document.querySelector("#peopleListingTableBody");
//  write functions
function loadPeopleListingTableBody() {
  for (const person of people) {
    let row = peopleListingTableBody.insertRow();
